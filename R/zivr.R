...
#' @return An object of class "zivr".
#' @export
zivr <- function(data, y, formula_bin = NULL, formula_cont = NULL, random = NULL,
  ...
  res <- .fit_zero_inflated_engine(
    ...
    model_name = "zivr", required_pkgs = c("vasicekreg", "statmod", "numDeriv"),
...
#' @export
print.zivr <- function(x, digits = 6, ...) {
...
#' @export
coef.zivr <- function(object, ...) object$estimates

#' @export
vcov.zivr <- function(object, ...) object$vcov

#' @export
logLik.zivr <- function(object, ...) {
...
#' @export
nobs.zivr <- function(object, ...) object$nobs

#' @export
# BIC compatible with SAS/NLMIXED: uses log(number of subjects)
BIC.zivr <- function(object, ...) {
