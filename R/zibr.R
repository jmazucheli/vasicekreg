# ======================================================================
# Zero-Inflated Beta model (formula interface)
# ======================================================================

#' Zero-Inflated Beta random-intercept model
#'
...
#' @return An object of class "zibr".
#' @export
zibr <- function(data, y, formula_bin = NULL, formula_cont = NULL, random = NULL,
  ...
  res <- .fit_zero_inflated_engine(
    ...
    model_name = "zibr", required_pkgs = c("statmod", "numDeriv"),
...
#' @export
print.zibr <- function(x, digits = 6, ...) {
...
#' @export
coef.zibr <- function(object, ...) object$estimates

#' @export
vcov.zibr <- function(object, ...) object$vcov

#' @export
logLik.zibr <- function(object, ...) {
...
#' @export
nobs.zibr <- function(object, ...) object$nobs

#' @export
# BIC compatible with SAS/NLMIXED: uses log(number of subjects)
BIC.zibr <- function(object, ...) {
